        ...
        <form name="submit" action="crud/saveclassrecord.php?id=<?php echo $teacherid?>&subject_name=<?php echo $subject?>&school_year=<?php echo $schoolyear?>&grading=<?php echo $grading?>" method="POST">
            ...
            <tr>
             ...
             <tr>
                ...
                <?php $hpstotal = $HPS['hpsw1']+$HPS['hpsw2']+$HPS['hpsw3']+$HPS['hpsw4']+$HPS['hpsw5']+$HPS['hpsw6']+$HPS['hpsw7']+$HPS['hpsw8']+$HPS['hpsw9']+$HPS['hpsw10'];?>
                ...
                <?php $hpstotal1 = $HPS['hpsp1']+$HPS['hpsp2']+$HPS['hpsp3']+$HPS['hpsp4']+$HPS['hpsp5']+$HPS['hpsp6']+$HPS['hpsp7']+$HPS['hpsp8']+$HPS['hpsp9']+$HPS['hpsp10'];?>
            ...
            <tr>          
                ...
                <?php
                $total = number_format(intval($W1[$a])+intval($W2[$a])+intval($W3[$a])+intval($W4[$a])+intval($W5[$a])+intval($W6[$a])+intval($W7[$a])+intval($W8[$a])+intval($W9[$a])+intval($W10[$a]),2);
                ?>
                <?php 
                ...
                <?php   $total1 = number_format((intval($PT1[$a])+intval($PT2[$a])+intval($PT3[$a])+intval($PT4[$a])+intval($PT5[$a])+intval($PT6[$a])+intval($PT7[$a])+intval($PT8[$a])+intval($PT9[$a])+intval($PT10[$a])),2)
                ?>
                <?php
                ...
                $tws1 = number_format(($total1/$hpstotal1*100/100*20),2);    
                }
            ...
            <tr>
                ...
                <?php 
               $gtotal = intval($GW1[$b])+intval($GW2[$b])+intval($GW3[$b])+intval($GW4[$b])+intval($GW5[$b])+intval($GW6[$b])+intval($GW7[$b])+intval($GW8[$b])+intval($GW9[$b])+intval($GW10[$b]);
                ?>
                <?php
               ...
               <td><?php echo "<input style='border:none' type='text' size='1' name='gpt1[]' value='$GPT1[$b]'/>"?></td>
                ...
                <?php $gtotal1 = intval($GPT1[$b])+intval($GPT2[$b])+intval($GPT3[$b])+intval($GPT4[$b])+intval($GPT5[$b])+intval($GPT6[$b])+intval($GPT7[$b])+intval($GPT8[$b])+intval($GPT9[$b])+intval($GPT10[$b]);
                ?>
                <?php
                  if($gtotal == 0 && $hpstotal == 0){
                    $gps1 = '0.00';
